...
length(na.omit(hpc$Global_reactive_power))
length(hpc$Global_reactive_power)
length(na.omit(hpc$Voltage))
length(hpc$Voltage)
...
legend("topright", pch=NA, lwd=1, col=c("black","blue", "red"), bty="n"
